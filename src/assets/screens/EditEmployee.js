...
const EditEmployee = () => {
    ...
    const handleSave = () => {
        (async() => {
            const save = await fetch('http://46.101.219.134:3001/save/employee', {
                method: 'POST',
    ...
    return (
        <>
            <Container bg="#10151A" maxW="100vw" h="100vh" color="white" className="edit-employee-wrapper">
                ...
                <p>Username</p>
                <input type="text" className="general-input" value={username} onChange={handleUsername} placeholder="Username" />
                <p>Name</p>
                <input type="text" className="general-input" value={name} onChange={handleName} placeholder="Name" />
                <p>Surname</p>
                <input type="text" className="general-input" value={surname} onChange={handleSurname} placeholder="Surname" />
                <p>Email</p>
                <input type="text" className="general-input" value={email} onChange={handleEmail} placeholder="Email" />
                <p>Phone Number</p>
                <input type="text" className="general-input" value={phone} onChange={handlePhoneNumber} placeholder="Phone Number" />
                <p>Role</p>
