...
const AddCar = () => {
	...
	return (
		...
		>
			...
			<button
				className="add-stock-btn add-stock-finish"
				onClick={handleAddCar}
			>
				Finish
			</button>
			<button className="add-stock-btn add-stock-cancel">
				<Link to="/manage/cars">Cancel</Link>
			</button>
		</Container>
	);
};
